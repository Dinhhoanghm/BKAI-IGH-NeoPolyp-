...
class NeoPolypModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_entropy_loss", e_loss, on_epoch=True)
        self.log("train_ft_loss", f_loss, on_epoch=True)
        self.log("train_dice_score", d_score, on_epoch=True)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_entropy_loss", e_loss, on_epoch=True)
        self.log("val_ft_loss", f_loss, on_epoch=True)
        self.log("val_dice_score", d_score, on_epoch=True)
        return loss
